                ...
                <div class="p-6 bg-gray-700">
                    ...
                    <form class="w-full max-w-sm" method="POST" action="">
                        ...
                        <div class="md:flex md:items-center mb-6">
                            <div class="md:w-1/3">
                                <label class="block text-gray-500 font-bold md:text-right mb-1 fmd:mb-0 pr-4" for="title">Title</label>
                            </div>
                        ...
                        <div class="md:flex md:items-center mb-6">
                                ...
                                <div class="md:w-2/3">
                                    <textarea class="resize border rounded-md" name="body" style="width:255pz;">{{$post->body}}</textarea>
                        ...
                        <div class="md:flex md:items-center">
                            ...
                            <div class="md:w-2/3">
                                <input class="shadow bg-blue-500 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit"  value="Update">
                            </div>
                        </div>
